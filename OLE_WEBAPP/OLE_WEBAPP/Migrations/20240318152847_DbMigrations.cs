        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    email_subscription = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_friend_requests", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_friend_requests_accounts_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_friend_requests_accounts_SenderId",
                        column: x => x.SenderId,
                        principalTable: "accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FriendshipTimeStamp = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_friends_list", x => x.FriendshipId);
                    table.ForeignKey(
                        name: "FK_friends_list_accounts_Account1Id",
                        column: x => x.Account1Id,
                        principalTable: "accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_friends_list_accounts_Account2Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_friends_list_Account1Id",
                table: "friends_list",
                column: "Account1Id");

            migrationBuilder.CreateIndex(
                name: "IX_friends_list_Account2Id",
                table: "friends_list",
                column: "Account2Id");
